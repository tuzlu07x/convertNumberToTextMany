                ...
                switch ($stepd) {
                    ...
                    case 3:
                        if ($items[substr($counter[$factor], $step - 1, 1)][0] == "") {
                            $str .= " ";
                        } elseif ($items[substr($counter[$factor], $step - 1, 1)][0] != "BIR") $str = $str . " " . $items[substr($counter[$factor], $step - 1, 1)][0] . " ONE HUNDRE";
